...
\begin{frame}{Motivation}
  \begin{itemize}
  \item Explore the data in different ways more efficient, flexible.    
  \item Generalize genomic visualization frame work and object-oriented visualization.
  \item Elegant graphics for publications.
  \item Modularize components to facilitate construction of high level graphics.
  \end{itemize}
\end{frame}
...
% a graphic goes here
\begin{center}
  \includegraphics[height = 0.8\textheight]{Figures/all.jpg}
\end{center}
\end{frame}
...
\begin{frame}{Package release/development}
  \begin{itemize}
  \item Bioconductor is the *ONLY* way to get released/devel version packages for ggbio.
...
\begin{frame}{How to get workshop code}
  \begin{itemize}
  \item https://github.com/tengfei/slides
  \item Find main.R file under bioc2012/ggbio.
  \end{itemize}
\end{frame}

\begin{frame}[fragile]{How to get vignette and example code}
  \begin{block}{}
@ 
...
@ %def 
  \end{block}
Down load pdf or copy R code.  
\end{frame}

\subsection{Case study I: Building ChIP-seq tracks.}
\begin{frame}
  \begin{itemize}
  \item Demo basically from tutorial for  seq data.    
  \item Goal:
    \begin{itemize}
...
\begin{frame}[fragile]{Overview of the top 50 different binding peaks}
  \begin{itemize}
  \item layout\_karyogram: stack all the chromosome 
  \item seqlength required.
  \end{itemize}
  \begin{block}{}
@ 
...
@ %def 
  \end{block}
  \begin{center}
    \includegraphics[height = 0.45\textheight, width = 0.7\textwidth]{main-overview}
  \end{center}
\end{frame}

\begin{frame}[fragile]{Define a region to dig into}
  \begin{itemize}
  \item Pick up a region of interest.
  \item That's a region which contains differential peaks.
  \end{itemize}
  \begin{block}{}
@ 
<<chip-gr>>=
...
\begin{frame}[fragile]{Get the example ChIP-seq data.}
  \scriptsize{
    \begin{block}{}
@ 
<<gr-instance>>=
...
\begin{frame}[fragile]{Default geom for GRanges object}  
  \begin{block}{}
@ 
...
\begin{frame}[fragile]{Facets by sample}
  \begin{center}
...
Task
\begin{itemize}
\item Faceted by strand and indicated as the row.
\end{itemize}
\end{frame}
...
@ %def 
  \end{block}
  \begin{center}
\includegraphics[height = 0.65\textheight, width = 0.65\textwidth]{main-chipseq-arb}    
  \end{center}
\end{frame}
...
@ %def 
  \end{block}
  \begin{center}
\includegraphics[height = 0.65\textheight, width = 0.65\textwidth]{main-chipseq-aes}    
  \end{center}
\end{frame}
...
\begin{frame}[allowframebreaks]{Extended grammar of graphics table}
% \begin{table}[h!t!b!p]
\begin{center}
\scriptsize{
...
\begin{frame}[fragile]{Save the coverage plot}
\begin{block}{}
@ 
...
\end{block}
  \begin{center}
\includegraphics[height = 0.65\textheight, width = 0.65\textwidth]{main-so-cov}    
  \end{center}
\end{frame}
